...
public class ArmatureController : MonoBehaviour {
    ...
    // Change articulationChain; this robot URDF is manipulable via IK at each of its two segments, 
    //  rather than doing joint-level control at its non-existent joints.
