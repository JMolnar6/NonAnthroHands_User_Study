...
public class GameManager : MonoBehaviour
{
    ...
    public TextMeshPro DebugReport;
    ...
    void Start()
    {
        ...
        //DebugReport = Find();
        // DebugReport = GameObject.Find("Debug Report 2").GetComponent<TextMeshPro>();
        DebugReport.SetText("Debug Info: ");// + ((int) statusUpdate["RedTeamScore"].n));
    ...
    IEnumerator SendWaypoint(){
        ...
        DebugReport.SetText("Debug Info: Now sending waypoints.");
        ...
        if (www.result != UnityWebRequest.Result.Success) { Debug.Log(www.error); }
            ...
            DebugReport.SetText("Debug Info: added waypoint!");
            }
    ...
    public List<float> GetFloatsFromString(string str){
        ...
        foreach (string item in splitString)
        {
            ...
            catch (System.Exception e)
            {
                ...
                DebugReport.SetText("Debug Info: Error. Value in string was not an int.");
        ...
        using (UnityWebRequest webRequest = UnityWebRequest.Get(uri))
        {
            ...
            switch (webRequest.result)
            {
                ...
                case UnityWebRequest.Result.DataProcessingError:
                    ...
                    DebugReport.SetText("Debug Info: " + pages[page] + ": Error: " + webRequest.error);
                    break;
                case UnityWebRequest.Result.ProtocolError:
                    Debug.LogError(pages[page] + ": HTTP Error: " + webRequest.error);
                    DebugReport.SetText("Debug Info: " + pages[page] + ": HTTP Error: " + webRequest.error);
                    break;
                case UnityWebRequest.Result.Success:
                    Debug.Log(pages[page] + ":\nReceived: " + webRequest.downloadHandler.text);
                    DebugReport.SetText("Debug Info: " + pages[page] + ":\nReceived: " + webRequest.downloadHandler.text);
    ...
    IEnumerator GetTeamNumber(int HeadsetID)
    {
        ...
        {
            Debug.Log(www.error);
            DebugReport.SetText("Debug Info: " + www.error);
        }
        else
        {
            ...
            if (TeamIDUpdate.Status == 200){
                ...
                DebugReport.SetText("Debug Info: Team is logged in!");
                ...
                if (TeamID == 0){
                    ...
                    DebugReport.SetText("Debug Info: TeamID is " + TeamID + ". You are the " + HandName);
                ...
                DebugReport.SetText("Debug Info: Error registering: code " + TeamIDUpdate.Status.ToString());
            }
        }
    }
