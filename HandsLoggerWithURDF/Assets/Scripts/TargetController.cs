...
public class TargetController : MonoBehaviour {
    ...
    public float tentacleLength = (float) 0.325; //Temporarily adjustable for ease of tuning. Needs to be much smaller for VR version, to match approx hand size
    ...
    private Vector3 GetQCPos(float base_length, Vector3 position){
        ...
        // Vector3 tempPos = tentacle.transform.position + height; // Useful if the tentacle is anchored to a moving object, i.e. the user's arm
